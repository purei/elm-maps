...
{-| -}
getMap : Model msg -> Maps.Internal.Map.Map
getMap model =
    OpaqueTypes.getMap model
...
updateMap update =
    opaqueModel <| Maps.updateMap <| transparentMap update
...
updateMarkers update =
    opaqueModel <| Maps.updateMarkers update
